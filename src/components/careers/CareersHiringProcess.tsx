import type { HiringStep } from "@/components/careers/careersData";

type CareersHiringProcessProps = {
  section: { eyebrow: string; heading: string };
  steps: HiringStep[];
};

export function CareersHiringProcess({ section, steps }: CareersHiringProcessProps) {
  return (
