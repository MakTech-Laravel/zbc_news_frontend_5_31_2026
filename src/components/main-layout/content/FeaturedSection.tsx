...
import { featuredCategories, featuredSpotlight } from "@/data/dummy/home";
...
export function FeaturedSection() {
  return (
    <div className="">
      <h2 className="font-general-sans text-3xl font-bold text-zbc-gray-1000 mb-2">Top Headlines</h2>
      <div className="overflow-hidden rounded-xs border border-border bg-zbc-gray-900 shadow-sm" aria-label="Featured media">
            ...
            >
              {featuredCategories.map((category, index) => (
                <Link
                  ...
                  to="#"
                  className={cn(
                    "shrink-0 rounded-full px-3.5 py-1.5 font-sans text-[12px] font-medium transition-colors",
                    index === 0
      ...
      <div className="mt-4">
        <div className="ml-4">
          <Link to={`/news-details`} className="line-clamp-2 mt-1 font-inter text-2xl font-bold leading-[1.15] text-zbc-gray-1000 sm:leading-tight lg:text-3xl hover:text-primary cursor-pointer">
            {featuredSpotlight.title}
          </Link>
          <div className="mt-2">
          <ArticleMeta
            author={featuredSpotlight.author}
            readTime={featuredSpotlight.readTime}
            views={1000}
          />
          </div>
        </div>
